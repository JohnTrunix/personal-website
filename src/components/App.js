    ...
    return (
        <div className="app">
            <div className="app_container">
                <img
                    className="app_container_img"
                    src={portrait}
                    alt="Portrait"
                />
                <div className="app_container_text_box">
                    <h1 className="app_container_name">
                        Hi, I'm John Truninger
                    </h1>
                ...
                <div className="app_container_social">
                    ...
                    <a
                        className="updown_animation app_container_social_icon"
                        href="https://johntrunix.github.io/data-science-jupyter-book/"
                        target="_blank"
                        rel="noopener noreferrer"
                    >
                        <img src={notebooksvg} alt="Jupyter Notebook" />
                    </a>
                </div>
            </div>
        </div>
